...
function initCategory() {
    ...
    dropdownContent.append('<a href="#book-list">Tất cả thể loại</a>'); // Add "All Categories" option at the beginning
...
function init() {
    ...
    if(user) {
        $('#user-info').text(`${user.userName}`); // Replace with actual user info if available
        $('#auth-btn').text('Đăng xuất');
